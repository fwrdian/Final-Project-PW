    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-zinc-950 overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-1/2 h-full opacity-5">
          <svg viewBox="0 0 200 200" className="w-full h-full"><circle cx="150" cy="100" r="120" stroke="white" strokeWidth="1" fill="none"/><circle cx="150" cy="100" r="80" stroke="white" strokeWidth="0.5" fill="none"/><circle cx="150" cy="100" r="40" stroke="white" strokeWidth="0.5" fill="none"/></svg>
        </div>
        <div className="max-w-7xl mx-auto px-6 md:px-8 py-16 relative">
          ...
          <p className="text-zinc-400 mt-3 text-base max-w-2xl">Ban, velg, kaca film, body kit, dan lebih banyak lagi. Upgrade kendaraan Anda ke level berikutnya dengan pilihan aksesori premium kami.</p>
